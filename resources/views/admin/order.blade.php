              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td>{{ $index + 1 }}</td>
                      <td>{{ $data['order_data']->payment_id }}</td>
                      <td>{{ $data['order_data']->payer_id }}</td>
                      <td>{{ $data['order_data']->payer_email }}</td>
                      <td>
                         @foreach($data['product_images'] as $productImage)
                          <img src="{{ asset($productImage) }}" alt="Product Image" style="max-width: 50px; max-height: 50px;">
                        @endforeach
                      </td>
                    </tr>
                    </a>
