              ...
              <form action="{{route('addNewProduct')}}" method="post" enctype="multipart/form-data">
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="number"step="0.01" class="form-control" name="price" id="price" placeholder="Enter Price of the Product">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputPassword1">Product tags</label>
                    <input type="text" class="form-control" name="data_tags" id="exampleInputPassword1" placeholder="Enter Product Tags">
                  </div>
                  <div class="form-group">
