            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-3">
                    <div class="header__nav__option">
                        <a href="#" class="search-switch"><img src="{{asset('malefashion/img/icon/search.png')}}" alt=""></a>
                        @if(isset($value))
                        <a href="{{route('wishlist')}}"><img src="{{asset('malefashion/img/icon/heart.png')}}" alt=""></a>
                        <a href="{{route('cart')}}"><img src="{{asset('malefashion/img/icon/cart.png')}}" alt=""> 
                        <span>0</span>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6 product__item" data-tags="{{$value->data_tags}}">
                            <div class="product__item">
                                ...
                                <div class="product__item__text">
                                    <h6>{{$value->name}}</h6>
                                    <a href="{{url('/add_cart/'.$value->id)}}" class="add-cart">+ Add To Cart</a>
                                    <div class="rating">
