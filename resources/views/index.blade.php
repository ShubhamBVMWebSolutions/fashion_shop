 ...
 @endphp
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-3">
                    <div class="header__nav__option">
                        ...
                        <a href="#"><img src="{{asset('malefashion/img/icon/heart.png')}}" alt=""></a>
                         @if(isset($value))
                        <a href="{{route('cart')}}"><img src="{{('malefashion/img/icon/cart.png')}}" alt=""> <span>0</span>
                        <span style="padding-left: 20px;font-weight: 700;font-size: small;">${{$totalPrice}}</span></a>
                        @endif
                    </div>
                </div>
            </div>
    ...
    <section class="hero">
        <div class="hero__slider owl-carousel">
            <div class="hero__items set-bg" data-setbg="{{asset('malefashion/img/hero/hero-1.jpg')}}">
                <div class="container">
                    <div class="row">
            ...
            <div class="hero__items set-bg" data-setbg="{{asset('malefashion/img/hero/hero-2.jpg')}}">
                <div class="container">
                    <div class="row">
                        <div class="col-xl-5 col-lg-7 col-md-8">
                            <div class="hero__text">
            ...
            <div class="row">
                <div class="col-lg-7 offset-lg-4">
                    <div class="banner__item">
                        <div class="banner__item__pic">
                            <img src="{{asset('malefashion/img/banner/banner-1.jpg')}}" alt="">
                        </div>
                ...
                <div class="col-lg-5">
                    <div class="banner__item banner__item--middle">
                        <div class="banner__item__pic">
                            <img src="{{asset('malefashion/img/banner/banner-2.jpg')}}" alt="">
                        </div>
                        <div class="banner__item__text">
                            <h2>Accessories</h2>
                            <a href="#">Shop now</a>
                ...
                <div class="col-lg-7">
                    <div class="banner__item banner__item--last">
                        <div class="banner__item__pic">
                            <img src="{{asset('malefashion/img/banner/banner-3.jpg')}}" alt="">
                        </div>
                        <div class="banner__item__text">
    ...
    <section class="product spad">
        <div class="container">
            ...
            <div class="row product__filter">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-md-6 col-sm-6 mix new-arrivals">
                    <div class="product__item">
                        <div class="product__item__pic set-bg" data-setbg="{{asset('malefashion/img/product/product-5.jpg')}}">
                            <ul class="product__hover">
                                <li><a href="#"><img src="{{asset('malefashion/img/icon/heart.png')}}" alt=""></a></li>
                                <li><a href="#"><img src="{{asset('malefashion/img/icon/compare.png')}}" alt=""> <span>Compare</span></a></li>
                                <li><a href="#"><img src="{{asset('malefashion/img/icon/search.png')}}" alt=""></a></li>
            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    <div class="categories__hot__deal">
                        <img src="{{asset('malefashion/img/product-sale.png')}}" alt="">
            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="instagram__pic">
                        <div class="instagram__pic__item set-bg" data-setbg="{{asset('malefashion/img/instagram/instagram-1.jpg')}}"></div>
                        <div class="instagram__pic__item set-bg" data-setbg="{{asset('malefashion/img/instagram/instagram-2.jpg')}}"></div>
                        <div class="instagram__pic__item set-bg" data-setbg="{{asset('malefashion/img/instagram/instagram-3.jpg')}}"></div>
                        <div class="instagram__pic__item set-bg" data-setbg="{{asset('malefashion/img/instagram/instagram-4.jpg')}}"></div>
                        <div class="instagram__pic__item set-bg" data-setbg="{{asset('malefashion/img/instagram/instagram-5.jpg')}}"></div>
                        <div class="instagram__pic__item set-bg" data-setbg="{{asset('malefashion/img/instagram/instagram-6.jpg')}}"></div>
                    </div>
                </div>
                <div class="col-lg-4">
