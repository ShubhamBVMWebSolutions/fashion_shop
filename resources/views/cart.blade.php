            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-3">
                    <div class="header__nav__option">
                        <a href="#" class="search-switch"><img src="{{asset('malefashion/img/icon/search.png')}}" alt=""></a>
                        <a href="#"><img src="{{asset('malefashion/img/icon/heart.png')}}" alt=""></a>
                        <a href="{{route('cart')}}"><img src="{{asset('malefashion/img/icon/cart.png')}}" alt=""> <span>0</span>
                ...
                <div class="col-lg-8">
                    <div class="shopping__cart__table">
                        <table>
                                ...
                                <tr>
                                    <td class="product__cart__item">
                                        <div class="product__cart__item__pic">
                                            <img src="{{asset($product->image)}}" alt="" style="max-width: 47%;">
                                        </div>
                                    </td>
                                    <td class="product__cart__name">
                            ...
                            @empty
                               <td>Please Select Some Items to view in cart</td> 
                            @endforelse                             
                        </table>
                    </div>
                    <div class="row">
                        ...
                        <ul>
                            ...
                            <li>
                                ...
                                <details>
                                    ...
                                    <p>Taxes(10%)</p>
                                    <p>Shipping Charges <span style=" text-decoration: line-through">$ 5 <span style="padding-left: 8px; color: green;">Free</span> </span></p>  
                                </details> 
                            </li>
                        </ul>
                        <form action="{{route('pay')}}" method="post">
                            @csrf
                            <input type="hidden" name="amount" value="{{$totalPriceWithTax}}">
                             <input type="hidden" name="ids" value="{{json_encode($allIds)}}">
